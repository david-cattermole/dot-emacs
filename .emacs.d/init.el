...
;; (ALT + Return)
(global-set-key (kbd "M-<return>") 'davidc-jump-to-matching-paren)
...
(when davidc-config-use-davidc-find
  ...
  (defalias 'dfind-files 'davidc-find-files)
  (defalias 'dfind-project-files 'davidc-find-project-files)
  (defalias 'dfind-directories 'davidc-find-directories)
  (defalias 'dfind-large-files 'davidc-find-large-files)
  (defalias 'dfind-recent-files 'davidc-find-recent-files)
  (defalias 'dfind-old-files 'davidc-find-old-files)
  (defalias 'dfind-executable-files 'davidc-find-executable-files)
  (defalias 'dfind-empty-files 'davidc-find-empty-files)
  (defalias 'dfind-empty-directories 'davidc-find-empty-directories)
  (defalias 'dfind-by-owner 'davidc-find-by-owner)

  ;; Functions to interactively change the config.
  (defalias 'dfind-set-backend 'davidc-find-set-backend)
